...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Landroid/content/Intent;
    ...
    invoke-virtual {v0, v2, v1}, Lp3/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-static {p0, p1}, Lk3/q;->c(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Landroid/content/Intent;
...
.method public static d(Landroid/content/Intent;)Lj3/b;
    .registers 4
    ...
    invoke-direct {p0, v0, v1}, Lj3/b;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-direct {v0, p0, v1}, Lj3/b;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
...
.method public static e(Lcom/google/android/gms/common/api/f;Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;Z)Lcom/google/android/gms/common/api/g;
    ...
    invoke-virtual {v0, v3, v2}, Lp3/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Lk3/r;->c(Landroid/content/Context;)Lk3/r;

    move-result-object v2

    invoke-virtual {v2}, Lk3/r;->b()Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
    ...
    :cond_22
    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->E()Landroid/accounts/Account;

    move-result-object v4

    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->E()Landroid/accounts/Account;
    ...
    :cond_36
    :goto_36
    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->T()Z
    ...
    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->S()Z
    ...
    :cond_4a
    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->Q()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->Q()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->P()Ljava/util/ArrayList;
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->P()Ljava/util/ArrayList;
    ...
    invoke-virtual {v2}, Lk3/r;->a()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;

    move-result-object v2

    if-eqz v2, :cond_1f

    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;->U()Z
    ...
    invoke-direct {v4, v2, v5}, Lj3/b;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v0, p2, p1}, Lp3/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v3, p2}, Lj3/b;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v0, v1, p3}, Lp3/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance p3, Lk3/k;

    invoke-direct {p3, p0, p1, p2}, Lk3/k;-><init>(Lcom/google/android/gms/common/api/f;Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)V
    ...
    invoke-direct {p1, p0}, Lcom/google/android/gms/common/api/internal/o;-><init>(Lcom/google/android/gms/common/api/h;)V
...
.method public static f(Lcom/google/android/gms/common/api/f;Landroid/content/Context;Z)Lcom/google/android/gms/common/api/h;
    ...
    invoke-static {p1}, Lk3/c;->b(Landroid/content/Context;)Lk3/c;

    move-result-object v0

    invoke-virtual {v0}, Lk3/c;->e()Ljava/lang/String;

    move-result-object v0

    invoke-static {p1}, Lk3/q;->h(Landroid/content/Context;)V

    if-eqz p2, :cond_1c

    invoke-static {v0}, Lk3/f;->a(Ljava/lang/String;)Lcom/google/android/gms/common/api/h;
    ...
    invoke-direct {p1, p0}, Lk3/o;-><init>(Lcom/google/android/gms/common/api/f;)V
...
.method public static g(Lcom/google/android/gms/common/api/f;Landroid/content/Context;Z)Lcom/google/android/gms/common/api/h;
    ...
    invoke-direct {p1, p0}, Lk3/m;-><init>(Lcom/google/android/gms/common/api/f;)V
...
.method private static h(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lk3/r;->c(Landroid/content/Context;)Lk3/r;

    move-result-object p0

    invoke-virtual {p0}, Lk3/r;->d()V

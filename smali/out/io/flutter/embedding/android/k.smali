...
.method public constructor <init>(Landroid/content/Context;IILio/flutter/embedding/android/k$b;)V
    ...
    invoke-static {p2, p3}, Lio/flutter/embedding/android/k;->h(II)Landroid/media/ImageReader;
...
.method constructor <init>(Landroid/content/Context;Landroid/media/ImageReader;Lio/flutter/embedding/android/k$b;)V
    ...
    invoke-direct {p0}, Lio/flutter/embedding/android/k;->i()V
...
.method private static h(II)Landroid/media/ImageReader;
    ...
    invoke-static {p0, v2}, Lio/flutter/embedding/android/k;->j(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, p0}, Lio/flutter/embedding/android/k;->j(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static/range {v3 .. v8}, Lio/flutter/embedding/android/h;->a(IIIIJ)Landroid/media/ImageReader;
...
.method private static varargs j(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, p0}, Lw7/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method private l()V
    ...
    invoke-static {v0}, Lio/flutter/embedding/android/i;->a(Landroid/media/Image;)Landroid/hardware/HardwareBuffer;
    ...
    invoke-static {v0, v1}, Lio/flutter/embedding/android/j;->a(Landroid/hardware/HardwareBuffer;Landroid/graphics/ColorSpace;)Landroid/graphics/Bitmap;
...
.method public b(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/k;->d:Lio/flutter/embedding/engine/renderer/FlutterRenderer;
...
.method public d()V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/k;->e()Z
    ...
    sget-object v2, Lio/flutter/embedding/android/k$b;->a:Lio/flutter/embedding/android/k$b;

    if-ne v1, v2, :cond_23

    iget-object v1, p0, Lio/flutter/embedding/android/k;->d:Lio/flutter/embedding/engine/renderer/FlutterRenderer;
...
.method public getAttachedRenderer()Lio/flutter/embedding/engine/renderer/FlutterRenderer;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/k;->d:Lio/flutter/embedding/engine/renderer/FlutterRenderer;
...
.method public k(II)V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/k;->g()V

    invoke-static {p1, p2}, Lio/flutter/embedding/android/k;->h(II)Landroid/media/ImageReader;
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/flutter/embedding/android/k;->k(II)V

    iget-object p1, p0, Lio/flutter/embedding/android/k;->d:Lio/flutter/embedding/engine/renderer/FlutterRenderer;

...
.field private s:Lk8/b;

.field private t:Lio/flutter/embedding/android/a0;
...
.field private x:Lio/flutter/embedding/android/f0;
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lio/flutter/embedding/android/l;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/s;->o:Ljava/util/Set;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/s;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/s;->z:Lio/flutter/view/g$k;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/s;->A:Landroid/database/ContentObserver;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/s;->B:Lio/flutter/embedding/engine/renderer/a;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/s;->C:Landroidx/core/util/a;
...
.method private C()V
    ...
    invoke-static {v0, v1}, Lw7/b;->g(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_e
    iget-object v0, p0, Lio/flutter/embedding/android/s;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->s()Lio/flutter/embedding/engine/renderer/FlutterRenderer;

    move-result-object v0

    iget-object v1, p0, Lio/flutter/embedding/android/s;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
...
.method static synthetic f(Lio/flutter/embedding/android/s;)Lio/flutter/embedding/engine/a;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;
...
.method static synthetic g(Lio/flutter/embedding/android/s;Z)Z
    ...
    iput-boolean p1, p0, Lio/flutter/embedding/android/s;->m:Z
...
.method public A(Ljava/lang/Runnable;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/k;->d()V
...
.method B()V
    ...
    sget-object v0, Li8/o$c;->c:Li8/o$c;

    goto :goto_1c

    :cond_1a
    sget-object v0, Li8/o$c;->b:Li8/o$c;

    :goto_1c
    iget-object v3, p0, Lio/flutter/embedding/android/s;->w:Landroid/view/textservice/TextServicesManager;
    ...
    iget-object v4, p0, Lio/flutter/embedding/android/s;->w:Landroid/view/textservice/TextServicesManager;
    ...
    :goto_44
    iget-object v4, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v4}, Lio/flutter/embedding/engine/a;->u()Li8/o;

    move-result-object v4

    invoke-virtual {v4}, Li8/o;->d()Li8/o$b;
    ...
    invoke-virtual {v4, v5}, Li8/o$b;->f(F)Li8/o$b;
    ...
    invoke-virtual {v4, v5}, Li8/o$b;->c(Landroid/util/DisplayMetrics;)Li8/o$b;

    move-result-object v4

    invoke-virtual {v4, v3}, Li8/o$b;->d(Z)Li8/o$b;
    ...
    :cond_7d
    invoke-virtual {v3, v1}, Li8/o$b;->b(Z)Li8/o$b;
    ...
    invoke-virtual {v1, v2}, Li8/o$b;->g(Z)Li8/o$b;

    move-result-object v1

    invoke-virtual {v1, v0}, Li8/o$b;->e(Li8/o$c;)Li8/o$b;

    move-result-object v0

    invoke-virtual {v0}, Li8/o$b;->a()V
...
.method public autofill(Landroid/util/SparseArray;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/s;->q:Lio/flutter/plugin/editing/m;
...
.method public checkInputConnectionProxy(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, p1}, Lio/flutter/plugin/platform/v;->G(Landroid/view/View;)Z
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/s;->t:Lio/flutter/embedding/android/a0;
...
.method public getAccessibilityNodeProvider()Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/s;->v:Lio/flutter/view/g;
...
.method public getBinaryMessenger()Lj8/c;
    .registers 2

    iget-object v0, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->j()Lx7/a;
...
.method public m(Lio/flutter/embedding/android/k;)V
    ...
    invoke-virtual {p1, v0}, Lio/flutter/embedding/android/k;->b(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
...
.method public n(Lio/flutter/embedding/engine/a;)V
    ...
    :cond_2e
    iput-object p1, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;
    ...
    iput-boolean v2, p0, Lio/flutter/embedding/android/s;->m:Z

    iget-object v2, p0, Lio/flutter/embedding/android/s;->d:Lio/flutter/embedding/engine/renderer/b;

    invoke-interface {v2, v0}, Lio/flutter/embedding/engine/renderer/b;->b(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V

    iget-object v2, p0, Lio/flutter/embedding/android/s;->B:Lio/flutter/embedding/engine/renderer/a;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v2}, Lio/flutter/embedding/engine/a;->m()Li8/h;

    move-result-object v2

    invoke-direct {v0, p0, v2}, Ll8/b;-><init>(Ll8/b$c;Li8/h;)V

    iput-object v0, p0, Lio/flutter/embedding/android/s;->p:Ll8/b;
    ...
    invoke-virtual {v2}, Lio/flutter/embedding/engine/a;->x()Li8/r;

    move-result-object v2

    iget-object v3, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v3}, Lio/flutter/embedding/engine/a;->p()Lio/flutter/plugin/platform/v;

    move-result-object v3

    invoke-direct {v0, p0, v2, v3}, Lio/flutter/plugin/editing/m;-><init>(Landroid/view/View;Li8/r;Lio/flutter/plugin/platform/v;)V

    iput-object v0, p0, Lio/flutter/embedding/android/s;->q:Lio/flutter/plugin/editing/m;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/s;->w:Landroid/view/textservice/TextServicesManager;

    new-instance v2, Lio/flutter/plugin/editing/f;

    iget-object v3, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v3}, Lio/flutter/embedding/engine/a;->v()Li8/p;

    move-result-object v3

    invoke-direct {v2, v0, v3}, Lio/flutter/plugin/editing/f;-><init>(Landroid/view/textservice/TextServicesManager;Li8/p;)V

    iput-object v2, p0, Lio/flutter/embedding/android/s;->r:Lio/flutter/plugin/editing/f;
    :try_end_85
    ...
    invoke-static {v1, v0}, Lw7/b;->b(Ljava/lang/String;Ljava/lang/String;)V

    :goto_8b
    iget-object v0, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->l()Lk8/b;

    move-result-object v0

    iput-object v0, p0, Lio/flutter/embedding/android/s;->s:Lk8/b;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/s;->t:Lio/flutter/embedding/android/a0;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/s;->u:Lio/flutter/embedding/android/c;

    new-instance v0, Lio/flutter/view/g;

    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->h()Li8/a;
    ...
    invoke-direct/range {v3 .. v8}, Lio/flutter/view/g;-><init>(Landroid/view/View;Li8/a;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/plugin/platform/p;)V

    iput-object v0, p0, Lio/flutter/embedding/android/s;->v:Lio/flutter/view/g;

    iget-object v1, p0, Lio/flutter/embedding/android/s;->z:Lio/flutter/view/g$k;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/s;->v:Lio/flutter/view/g;
    ...
    invoke-virtual {v0, v1}, Lio/flutter/plugin/platform/v;->a(Lio/flutter/view/g;)V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/plugin/platform/v;->E(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
    ...
    iget-object v3, p0, Lio/flutter/embedding/android/s;->A:Landroid/database/ContentObserver;
    ...
    invoke-virtual {v0, p0}, Lio/flutter/plugin/platform/v;->F(Lio/flutter/embedding/android/s;)V

    iget-object v0, p0, Lio/flutter/embedding/android/s;->o:Ljava/util/Set;
    ...
    :cond_13d
    iget-boolean p1, p0, Lio/flutter/embedding/android/s;->m:Z

    if-eqz p1, :cond_146

    iget-object p1, p0, Lio/flutter/embedding/android/s;->B:Lio/flutter/embedding/engine/renderer/a;

    invoke-interface {p1}, Lio/flutter/embedding/engine/renderer/a;->e()V
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1}, Landroidx/core/view/o1;->a(Landroid/view/WindowInsets;)Landroid/graphics/Insets;

    move-result-object v2

    iget-object v3, p0, Lio/flutter/embedding/android/s;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    :cond_49
    invoke-static {p1, v4}, Landroidx/core/view/t1;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;

    move-result-object v1

    iget-object v2, p0, Lio/flutter/embedding/android/s;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    invoke-static {p1, v1}, Landroidx/core/view/t1;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {p1}, Landroidx/core/view/m1;->a(Landroid/view/WindowInsets;)Landroid/view/DisplayCutout;
    ...
    :cond_f6
    iget-object v5, p0, Lio/flutter/embedding/android/s;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    iget-object p1, p0, Lio/flutter/embedding/android/s;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
...
.method protected onAttachedToWindow()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/s;->x:Lio/flutter/embedding/android/f0;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0}, La9/h;->f(Landroid/content/Context;)Landroid/app/Activity;

    move-result-object v0

    iget-object v1, p0, Lio/flutter/embedding/android/s;->x:Lio/flutter/embedding/android/f0;
    ...
    iget-object v3, p0, Lio/flutter/embedding/android/s;->C:Landroidx/core/util/a;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/s;->s:Lk8/b;

    invoke-virtual {v0, p1}, Lk8/b;->d(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1, v0}, La9/h;->c(Landroid/content/Context;La9/h$a;)V
...
.method public onCreateInputConnection(Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/s;->t:Lio/flutter/embedding/android/a0;
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/s;->x:Lio/flutter/embedding/android/f0;

    if-eqz v0, :cond_9

    iget-object v1, p0, Lio/flutter/embedding/android/s;->C:Landroidx/core/util/a;
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/s;->u:Lio/flutter/embedding/android/c;
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-static {p4, p3}, Lw7/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p3, p0, Lio/flutter/embedding/android/s;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
...
.method public p()V
    ...
    invoke-interface {v0, v1}, Lio/flutter/embedding/engine/renderer/b;->b(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
...
.method public s()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/s;->A:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/s;->q:Lio/flutter/plugin/editing/m;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/s;->r:Lio/flutter/plugin/editing/f;
    ...
    :cond_7b
    iget-object v1, p0, Lio/flutter/embedding/android/s;->p:Ll8/b;
    ...
    iget-object v3, p0, Lio/flutter/embedding/android/s;->B:Lio/flutter/embedding/engine/renderer/a;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/s;->n:Lio/flutter/embedding/engine/a;
...
.method protected setWindowInfoListenerDisplayFeatures(Landroidx/window/layout/WindowLayoutInfo;)V
    ...
    invoke-static {v2, v3}, Lw7/b;->f(Ljava/lang/String;Ljava/lang/String;)V

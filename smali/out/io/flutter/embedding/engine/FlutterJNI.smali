...
.field private deferredComponentManager:Ly7/a;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Lw7/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lx7/f;

    if-eqz v0, :cond_7

    invoke-interface {v0, p1, p2}, Lx7/f;->g(ILjava/nio/ByteBuffer;)V
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lk8/b;
    ...
    :cond_47
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lk8/b;

    invoke-virtual {p1, v0}, Lk8/b;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/v;->K()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public destroyOverlaySurfaces()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/v;->N()V
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Lw7/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/g$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Lj8/r;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Li8/o;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Lx7/f;->h(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Ly7/a;

    if-eqz v0, :cond_9

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Ly7/a;->a(ILjava/lang/String;)V
...
.method public setDeferredComponentManager(Ly7/a;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Ly7/a;

    if-eqz p1, :cond_a

    invoke-interface {p1, p0}, Ly7/a;->e(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_a
    return-void
.end method

.method public setLocalizationPlugin(Lk8/b;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lk8/b;

    return-void
.end method

.method public setPlatformMessageHandler(Lx7/f;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lx7/f;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, La9/c;->a(ZLjava/lang/Object;)V

...
# instance fields
.field private final a:Lc9/a1$e;

.field final synthetic b:Lio/grpc/internal/e0;


# direct methods
.method constructor <init>(Lio/grpc/internal/e0;Lc9/a1$e;)V
    .registers 3
    ...
    iput-object p1, p0, Lio/grpc/internal/e0$e;->a:Lc9/a1$e;
...
.method public run()V
    ...
    invoke-static {v4}, Lio/grpc/internal/e0;->i(Lio/grpc/internal/e0;)Lc9/x;
    ...
    invoke-virtual {v5, v1}, Lc9/a1$g$a;->b(Ljava/util/List;)Lc9/a1$g$a;
    ...
    invoke-static {v0}, Lio/grpc/internal/e0$c;->c(Lio/grpc/internal/e0$c;)Lc9/j1;

    move-result-object v1

    if-eqz v1, :cond_91

    iget-object v1, p0, Lio/grpc/internal/e0$e;->a:Lc9/a1$e;

    invoke-static {v0}, Lio/grpc/internal/e0$c;->c(Lio/grpc/internal/e0$c;)Lc9/j1;

    move-result-object v4

    invoke-virtual {v1, v4}, Lc9/a1$e;->b(Lc9/j1;)V
    :try_end_78
    ...
    invoke-static {v0}, Lio/grpc/internal/e0;->f(Lio/grpc/internal/e0;)Lc9/n1;
    ...
    :cond_9e
    invoke-static {v0}, Lio/grpc/internal/e0$c;->e(Lio/grpc/internal/e0$c;)Lc9/a1$c;
    ...
    invoke-virtual {v5, v1}, Lc9/a1$g$a;->d(Lc9/a1$c;)Lc9/a1$g$a;

    :cond_ab
    iget-object v1, v0, Lio/grpc/internal/e0$c;->d:Lc9/a;

    if-eqz v1, :cond_b2

    invoke-virtual {v5, v1}, Lc9/a1$g$a;->c(Lc9/a;)Lc9/a1$g$a;

    :cond_b2
    :goto_b2
    iget-object v1, p0, Lio/grpc/internal/e0$e;->a:Lc9/a1$e;

    invoke-virtual {v5}, Lc9/a1$g$a;->a()Lc9/a1$g;

    move-result-object v4

    invoke-virtual {v1, v4}, Lc9/a1$e;->c(Lc9/a1$g;)V
    :try_end_bb
    ...
    :try_start_d7
    iget-object v4, p0, Lio/grpc/internal/e0$e;->a:Lc9/a1$e;

    sget-object v5, Lc9/j1;->u:Lc9/j1;
    ...
    invoke-virtual {v5, v1}, Lc9/j1;->p(Ljava/lang/Throwable;)Lc9/j1;

    move-result-object v1

    invoke-virtual {v4, v1}, Lc9/a1$e;->b(Lc9/j1;)V
    :try_end_fd
    ...
    invoke-virtual {v0, v3}, Lc9/n1;->execute(Ljava/lang/Runnable;)V

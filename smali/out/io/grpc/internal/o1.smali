...
.method public constructor <init>(Lio/grpc/internal/o1$d;Lio/grpc/internal/v2;Lio/grpc/internal/n2;)V
    ...
    iput-object v1, p0, Lio/grpc/internal/o1;->d:Lc9/n;
...
.method static synthetic b(Lio/grpc/internal/o1;)Lio/grpc/internal/v2;
    .registers 1
...
.method private c(ZZ)V
    ...
    invoke-interface {v1, v0, p1, p2, v2}, Lio/grpc/internal/o1$d;->o(Lio/grpc/internal/u2;ZZI)V
...
.method private k(Lio/grpc/internal/o1$b;Z)V
    ...
    invoke-static {p1}, Lio/grpc/internal/o1$b;->a(Lio/grpc/internal/o1$b;)I
    ...
    invoke-interface {v1, p2, v3, v3, v2}, Lio/grpc/internal/o1$d;->o(Lio/grpc/internal/u2;ZZI)V

    iput v4, p0, Lio/grpc/internal/o1;->k:I

    invoke-static {p1}, Lio/grpc/internal/o1$b;->b(Lio/grpc/internal/o1$b;)Ljava/util/List;
    ...
    invoke-interface {v1, v2, v3, v3, v3}, Lio/grpc/internal/o1$d;->o(Lio/grpc/internal/u2;ZZI)V
...
.method private l(Ljava/io/InputStream;I)I
    ...
    iget-object v0, p0, Lio/grpc/internal/o1;->d:Lc9/n;

    invoke-interface {v0, p2}, Lc9/n;->c(Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    :cond_1b
    sget-object p2, Lc9/j1;->o:Lc9/j1;
...
.method private m(Ljava/io/InputStream;I)I
    ...
    :cond_8
    sget-object p1, Lc9/j1;->o:Lc9/j1;
...
.method private n([BII)V
    ...
    invoke-direct {p0, v0, v0}, Lio/grpc/internal/o1;->c(ZZ)V
...
.method private static o(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    ...
    instance-of v0, p0, Lc9/w;

    if-eqz v0, :cond_b

    check-cast p0, Lc9/w;

    invoke-interface {p0, p1}, Lc9/w;->a(Ljava/io/OutputStream;)I
    ...
    :cond_b
    invoke-static {p0, p1}, Li4/b;->b(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    invoke-static {v0, v1, p0, p1}, Lg4/o;->j(ZLjava/lang/String;J)V
...
.method public close()V
    ...
    invoke-interface {v1}, Lio/grpc/internal/u2;->c()I

    move-result v1

    if-nez v1, :cond_16

    invoke-direct {p0}, Lio/grpc/internal/o1;->h()V
...
.method public bridge synthetic d(Lc9/n;)Lio/grpc/internal/r0;
    .registers 2

    invoke-virtual {p0, p1}, Lio/grpc/internal/o1;->i(Lc9/n;)Lio/grpc/internal/o1;
...
.method public e(Ljava/io/InputStream;)V
    ...
    iget-object v1, p0, Lio/grpc/internal/o1;->d:Lc9/n;

    sget-object v4, Lc9/l$b;->a:Lc9/l;
    ...
    invoke-virtual {v1, v0}, Lc9/j1;->q(Ljava/lang/String;)Lc9/j1;
...
.method public flush()V
    ...
    invoke-interface {v0}, Lio/grpc/internal/u2;->c()I
    ...
    invoke-direct {p0, v0, v1}, Lio/grpc/internal/o1;->c(ZZ)V
...
.method public i(Lc9/n;)Lio/grpc/internal/o1;
    .registers 3
    ...
    iput-object p1, p0, Lio/grpc/internal/o1;->d:Lc9/n;

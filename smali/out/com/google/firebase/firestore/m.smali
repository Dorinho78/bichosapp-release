...
# direct methods
.method constructor <init>(Lz5/l;Lcom/google/firebase/firestore/FirebaseFirestore;)V
    .registers 3
    ...
    iput-object p1, p0, Lcom/google/firebase/firestore/m;->a:Lz5/l;
...
.method public static synthetic a(Lcom/google/firebase/firestore/m;Lcom/google/firebase/firestore/o;Lw5/x1;Lcom/google/firebase/firestore/z;)V
    .registers 4

    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/firestore/m;->p(Lcom/google/firebase/firestore/o;Lw5/x1;Lcom/google/firebase/firestore/z;)V
...
.method private f(Ljava/util/concurrent/Executor;Lw5/o$a;Landroid/app/Activity;Lcom/google/firebase/firestore/o;)Lcom/google/firebase/firestore/f0;
    .registers 6
    ...
    new-instance p4, Lw5/h;

    invoke-direct {p4, p1, v0}, Lw5/h;-><init>(Ljava/util/concurrent/Executor;Lcom/google/firebase/firestore/o;)V

    invoke-direct {p0}, Lcom/google/firebase/firestore/m;->g()Lw5/a1;
    ...
    invoke-virtual {v0, p1, p2, p4}, Lw5/o0;->d0(Lw5/a1;Lw5/o$a;Lcom/google/firebase/firestore/o;)Lw5/b1;

    move-result-object p1

    new-instance p2, Lw5/v0;
    ...
    invoke-direct {p2, v0, p1, p4}, Lw5/v0;-><init>(Lw5/o0;Lw5/b1;Lw5/h;)V

    invoke-static {p3, p2}, Lw5/d;->c(Landroid/app/Activity;Lcom/google/firebase/firestore/f0;)Lcom/google/firebase/firestore/f0;
...
.method private g()Lw5/a1;
    .registers 2

    iget-object v0, p0, Lcom/google/firebase/firestore/m;->a:Lz5/l;

    invoke-virtual {v0}, Lz5/l;->r()Lz5/u;

    move-result-object v0

    invoke-static {v0}, Lw5/a1;->b(Lz5/u;)Lw5/a1;
...
.method static i(Lz5/u;Lcom/google/firebase/firestore/FirebaseFirestore;)Lcom/google/firebase/firestore/m;
    .registers 4
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/firebase/firestore/m;-><init>(Lz5/l;Lcom/google/firebase/firestore/FirebaseFirestore;)V
    ...
    invoke-virtual {p0}, Lz5/u;->h()Ljava/lang/String;
...
.method private n(Lcom/google/firebase/firestore/b1;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v2}, Lw5/o$a;-><init>()V

    const/4 v3, 0x1

    iput-boolean v3, v2, Lw5/o$a;->a:Z

    iput-boolean v3, v2, Lw5/o$a;->b:Z

    iput-boolean v3, v2, Lw5/o$a;->c:Z

    sget-object v3, Ld6/p;->b:Ljava/util/concurrent/Executor;

    new-instance v4, Lcom/google/firebase/firestore/l;

    invoke-direct {v4, v0, v1, p1}, Lcom/google/firebase/firestore/l;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/firebase/firestore/b1;)V

    const/4 p1, 0x0

    invoke-direct {p0, v3, v2, p1, v4}, Lcom/google/firebase/firestore/m;->f(Ljava/util/concurrent/Executor;Lw5/o$a;Landroid/app/Activity;Lcom/google/firebase/firestore/o;)Lcom/google/firebase/firestore/f0;
...
.method private static o(Lcom/google/firebase/firestore/o0;)Lw5/o$a;
    .registers 6
    ...
    :goto_e
    iput-boolean v4, v0, Lw5/o$a;->a:Z
    ...
    :goto_14
    iput-boolean v2, v0, Lw5/o$a;->b:Z

    iput-boolean v3, v0, Lw5/o$a;->c:Z

    return-object v0
.end method

.method private synthetic p(Lcom/google/firebase/firestore/o;Lw5/x1;Lcom/google/firebase/firestore/z;)V
    .registers 9
    ...
    invoke-virtual {p2}, Lw5/x1;->e()Lz5/n;
    ...
    invoke-static {p3, v2, v1}, Ld6/b;->d(ZLjava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p2}, Lw5/x1;->e()Lz5/n;

    move-result-object p3

    iget-object v1, p0, Lcom/google/firebase/firestore/m;->a:Lz5/l;

    invoke-virtual {p3, v1}, Lz5/n;->h(Lz5/l;)Lz5/i;

    move-result-object p3

    if-eqz p3, :cond_4b

    invoke-virtual {p2}, Lw5/x1;->f()Ll5/e;
    ...
    invoke-virtual {v1, v2}, Ll5/e;->contains(Ljava/lang/Object;)Z
    ...
    invoke-static {v2, p3, p2, v1}, Lcom/google/firebase/firestore/n;->b(Lcom/google/firebase/firestore/FirebaseFirestore;Lz5/i;ZZ)Lcom/google/firebase/firestore/n;
    ...
    invoke-static {p3, v1, p2}, Lcom/google/firebase/firestore/n;->c(Lcom/google/firebase/firestore/FirebaseFirestore;Lz5/l;Z)Lcom/google/firebase/firestore/n;
...
.method private synthetic q(Lcom/google/android/gms/tasks/Task;)Lcom/google/firebase/firestore/n;
    ...
    iget-object v2, p0, Lcom/google/firebase/firestore/m;->a:Lz5/l;
...
.method private static synthetic r(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/firebase/firestore/b1;Lcom/google/firebase/firestore/n;Lcom/google/firebase/firestore/z;)V
    ...
    invoke-static {p0, v0, p1}, Ld6/b;->b(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/AssertionError;
...
.method private v(Lw5/s1;)Lcom/google/android/gms/tasks/Task;
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2}, La6/m;->a(Z)La6/m;

    move-result-object v2

    invoke-virtual {p1, v1, v2}, Lw5/s1;->a(Lz5/l;La6/m;)La6/f;
    ...
    invoke-virtual {v0, p1}, Lw5/o0;->m0(Ljava/util/List;)Lcom/google/android/gms/tasks/Task;

    move-result-object p1

    sget-object v0, Ld6/p;->b:Ljava/util/concurrent/Executor;

    invoke-static {}, Ld6/h0;->C()Lcom/google/android/gms/tasks/Continuation;
...
.method public e(Ljava/util/concurrent/Executor;Lcom/google/firebase/firestore/o0;Lcom/google/firebase/firestore/o;)Lcom/google/firebase/firestore/f0;
    ...
    invoke-static {p2}, Lcom/google/firebase/firestore/m;->o(Lcom/google/firebase/firestore/o0;)Lw5/o$a;

    move-result-object p2

    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, v0, p3}, Lcom/google/firebase/firestore/m;->f(Ljava/util/concurrent/Executor;Lw5/o$a;Landroid/app/Activity;Lcom/google/firebase/firestore/o;)Lcom/google/firebase/firestore/f0;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lcom/google/firebase/firestore/m;->a:Lz5/l;
...
.method public h()Lcom/google/android/gms/tasks/Task;
    ...
    sget-object v3, La6/m;->c:La6/m;

    invoke-direct {v1, v2, v3}, La6/c;-><init>(Lz5/l;La6/m;)V
...
.method public j(Lcom/google/firebase/firestore/b1;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {p1}, Lcom/google/firebase/firestore/FirebaseFirestore;->s()Lw5/o0;

    move-result-object p1

    iget-object v0, p0, Lcom/google/firebase/firestore/m;->a:Lz5/l;

    invoke-virtual {p1, v0}, Lw5/o0;->B(Lz5/l;)Lcom/google/android/gms/tasks/Task;
...
.method public m()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lz5/u;->h()Ljava/lang/String;
...
.method public t(Ljava/lang/Object;Lcom/google/firebase/firestore/z0;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {p2}, Lcom/google/firebase/firestore/z0;->a()La6/d;

    move-result-object p2

    invoke-virtual {v0, p1, p2}, Lcom/google/firebase/firestore/g1;->g(Ljava/lang/Object;La6/d;)Lw5/r1;
    ...
    invoke-virtual {p2, p1}, Lcom/google/firebase/firestore/g1;->l(Ljava/lang/Object;)Lw5/r1;
    ...
    invoke-virtual {p2}, Lcom/google/firebase/firestore/FirebaseFirestore;->s()Lw5/o0;
    ...
    invoke-virtual {p1, v0, v1}, Lw5/r1;->a(Lz5/l;La6/m;)La6/f;
    ...
    invoke-virtual {p2, p1}, Lw5/o0;->m0(Ljava/util/List;)Lcom/google/android/gms/tasks/Task;

    move-result-object p1

    sget-object p2, Ld6/p;->b:Ljava/util/concurrent/Executor;
...
.method public varargs u(Lcom/google/firebase/firestore/q;Ljava/lang/Object;[Ljava/lang/Object;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-static {v1, p1, p2, p3}, Ld6/h0;->f(ILjava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/util/List;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/google/firebase/firestore/g1;->n(Ljava/util/List;)Lw5/s1;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/google/firebase/firestore/m;->v(Lw5/s1;)Lcom/google/android/gms/tasks/Task;

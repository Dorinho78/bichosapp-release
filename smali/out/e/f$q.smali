...
.method constructor <init>(I)V
    ...
    iput p1, p0, Le/f$q;->a:I

    const/4 p1, 0x0

    iput-boolean p1, p0, Le/f$q;->q:Z
...
.method a(Landroidx/appcompat/view/menu/j$a;)Landroidx/appcompat/view/menu/k;
    ...
    iget-object v0, p0, Le/f$q;->j:Landroidx/appcompat/view/menu/e;
    ...
    :cond_6
    iget-object v0, p0, Le/f$q;->k:Landroidx/appcompat/view/menu/c;

    if-nez v0, :cond_1f

    new-instance v0, Landroidx/appcompat/view/menu/c;

    iget-object v1, p0, Le/f$q;->l:Landroid/content/Context;

    sget v2, Ld/g;->j:I

    invoke-direct {v0, v1, v2}, Landroidx/appcompat/view/menu/c;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Le/f$q;->k:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/c;->h(Landroidx/appcompat/view/menu/j$a;)V

    iget-object p1, p0, Le/f$q;->j:Landroidx/appcompat/view/menu/e;
    ...
    :cond_1f
    iget-object p1, p0, Le/f$q;->k:Landroidx/appcompat/view/menu/c;

    iget-object v0, p0, Le/f$q;->g:Landroid/view/ViewGroup;
...
.method public b()Z
    ...
    iget-object v0, p0, Le/f$q;->h:Landroid/view/View;
    ...
    :cond_6
    iget-object v0, p0, Le/f$q;->i:Landroid/view/View;
...
.method c(Landroidx/appcompat/view/menu/e;)V
    ...
    iget-object v1, p0, Le/f$q;->k:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/e;->O(Landroidx/appcompat/view/menu/j;)V

    :cond_c
    iput-object p1, p0, Le/f$q;->j:Landroidx/appcompat/view/menu/e;
...
.method d(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Le/f$q;->l:Landroid/content/Context;

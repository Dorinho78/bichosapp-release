...
.method private final addListener(Ljava/util/concurrent/Executor;Landroidx/core/util/a;Lka/b;)V
    .registers 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1}, Lha/m0;->a(Lq9/g;)Lha/l0;
    ...
    invoke-direct {v4, p3, p2, v5}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter$addListener$1$1;-><init>(Lka/b;Landroidx/core/util/a;Lq9/d;)V
...
.method private final removeListener(Landroidx/core/util/a;)V
    ...
    invoke-static {v1, v3, v2, v3}, Lha/x1$a;->a(Lha/x1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
...
.method public final addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/core/util/a;)V
    ...
    invoke-interface {v0, p1}, Landroidx/window/layout/WindowInfoTracker;->windowLayoutInfo(Landroid/app/Activity;)Lka/b;

    move-result-object p1

    invoke-direct {p0, p2, p3, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addListener(Ljava/util/concurrent/Executor;Landroidx/core/util/a;Lka/b;)V
...
.method public windowLayoutInfo(Landroid/app/Activity;)Lka/b;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",

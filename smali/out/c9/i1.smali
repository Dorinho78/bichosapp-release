...
.method static b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    invoke-static {p0, v1}, Lc9/i1;->a(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public static e(Ljava/lang/Class;Ljava/lang/Iterable;Ljava/lang/ClassLoader;Lc9/i1$b;)Ljava/util/List;
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p2}, Lc9/i1;->d(Ljava/lang/ClassLoader;)Z

    move-result v0

    if-eqz v0, :cond_b

    invoke-static {p0, p1}, Lc9/i1;->b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    :cond_b
    invoke-static {p0, p2}, Lc9/i1;->c(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/lang/Iterable;
    ...
    invoke-interface {p3, p2}, Lc9/i1$b;->a(Ljava/lang/Object;)Z
    ...
    :cond_2d
    new-instance p0, Lc9/i1$a;

    invoke-direct {p0, p3}, Lc9/i1$a;-><init>(Lc9/i1$b;)V
